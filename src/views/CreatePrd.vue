        ...
        <section class="p-fluid p-d-flex p-jc-center section">
            <form class="p-md-6 p-xl-3 p-lg-6 p-sm-12 p-col-12">
                ...
                <div class="p-field p-grid">
                    ...
                    <div class="p-col-12 p-md-12 p-mt-2">
                        <InputText id="productPrice" v-model="product.price" min="1" max="90000" placeholder="商品價格"
                            type="text" />
                    </div>
                </div>
                    ...
                    <div class="upload p-col-12 p-md-12 p-p-0 p-mt-2">
                        <div class="upload-head p-d-flex p-flex-wrap p-jc-center p-ai-center">
                            <Button class="p-d-flex p-jc-center p-p-0" :class="{ 'p-disabled': Notupload }">
                                <label class="p-button-primary p-md-12 p-sm-12 p-col-12 choose-label"
                                    style="cursor:pointer">
                                    <input id="upload_img" style="display:none;" accept="image/*" @change="previewImage"
                                        type="file" multiple />
                                    選擇圖片
                                </label>
                            </Button>
                            <Button @click.prevent="importImg" :label="!Notupload ? '匯入' : '匯入完畢'"
                                :class="{ 'p-disabled': Notupload }" class="btn" />
                            <Button @click.prevent="removeAllImg" label="取消" :class="{ 'p-disabled': Notupload }"
                                class="btn" />
                        </div>
                                ...
                                <ScrollPanel class="scroll-panel">
                                    <tr v-for="(item, index) in preview" :key="index" class="p-d-flex p-ai-center">
                                        ...
                                        <td class="p-md-4 p-col-3 p-d-flex p-jc-center p-ai-center">
                                            <Button v-if="!Notupload" @click.prevent="deleteItem(index)"
                                                icon="pi pi-times"
                ...
                <div class="p-field p-grid p-mt-3">
                    ...
                    <div class="p-col-12 p-md-12 p-mt-2">
                        <Dropdown v-model="product.category" :options="sellings" optionLabel="name" optionValue="code"
                            placeholder="商品分類" />
                    </div>
                </div>
                <div class="p-field p-grid">
                    <div class="p-col-12 p-md-12">
                        <Button class="p-d-flex p-jc-center p-p-0">
                            <label class="p-button-info p-md-12" style="cursor:pointer">
                                <input id="upload_img" style="display:none;" accept="image/*" @change="chooseExcel"
                                    type="file" multiple />
                                上傳產品規格
                            </label>
                        </Button>
