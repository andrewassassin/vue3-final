            ...
            <form v-on:submit.prevent="createForm($event)" class="createProductForm">
                ...
                <div class="upload">
                  <div class="upload-head">
                      ...
                      <button type="click" class="btn btn-primary ml-3" @click.prevent="upload">上傳圖片</button>
                      ...
                      <table id="cartTableBody">
                        <ScrollPanel class="scroll-panel">
                          <tr v-for="item, index in preview" :key="index">
                              ...
                              <td class="text-left td-img"> {{ imgList[index].name}}</td>
                              <td class="text-left td-img">size: {{ Math.round(imgList[index].size/1024  * 10) / 10 }}KB</td>
                              <td class="td-img row align-items-center justify-content-center">
